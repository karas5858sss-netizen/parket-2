...
const LABEL = { me: PEOPLE.me.name, her: PEOPLE.her.name };
...
// Единственный источник — config/profiles.js (загружается раньше этого файла, кладёт себя
// в window.PEOPLE). Здесь только «переупаковка» под форму, удобную для остального клиента.
